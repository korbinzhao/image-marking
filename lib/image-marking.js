...
var ImageMarking = function (_React$Component) {
  ...
  function ImageMarking(props) {
    ...
    _this.endDrawing = function (e) {
      _this.clearTempDrawingLine();
      _this.drawingShape = null;
    ...
    _this.drawLine = function (e) {
      ...
      if (drawing) {
        _this.drawingShape.points.pop();
        _this.drawingShape.points.push([position.x, position.y]);

        var tempShapesData = shapesData.concat([_this.drawingShape]);

        _this.drawShapes(tempShapesData);
      }
    };
    ...
    _this.addPoint = function (position) {
      ...
      if (drawing) {
        ...
        _this.drawShapes(shapesData.concat([_this.drawingShape]));
      }
    };
    ...
    _this.dragMoveTimer = { id: null }; // 用于 dragMove 事件的节流阀函数
    _this.snap = null; // Snap 实例
    _this.clickTimer = null; // 点击事件 timer，用于区分单双击
    _this.clickCount = 0; // 用于点击次数计数，区分单双击
    _this.drawingShape = null; // 正在绘制的图形数据
    return _this;
  }
  ...
  _createClass(ImageMarking, [{
    ...
    key: "clearTempDrawingLine",


    /**
     * 清除绘制图形时产生的临时线条
     */
    value: function clearTempDrawingLine() {
      var _this5 = this;
      ...
      var temp = shapesData.concat([this.drawingShape]);

      this.setState({
        shapesData: temp
      }, function () {
        _this5.drawShapes(temp);
      });
    ...
    value: function deleteShapesActived() {
      ...
      this.setState({
        ...
        var onShapesDelete = _this6.props.onShapesDelete;

        _this6.setOperateBtnDisableState();
        onShapesDelete(elements);
        _this6.onShapesDataChange(shapesData);
      });
    }
    ...
    value: function handleShapesData(shapesData) {
      ...
      var result = shapesData.filter(function (item) {
        var points = _this7.uniqueShapePoints(item.points);
        item.points = points;
        if (points.length === 1) {
          // 只有一个顶点则不保存
          return false;
    ...
    value: function render() {
      ...
      var _state = this.state,
          contextMenuColumns = _state.contextMenuColumns,
          deleteDisable = _state.deleteDisable,
          groupDisable = _state.groupDisable,
          isDeleteConfirmVisible = _state.isDeleteConfirmVisible;
      ...
      var operationBar = _react2.default.createElement(
        ...
        _react2.default.createElement("i", {
          ...
          onClick: function onClick() {
            return _this8.onOperateBtnClick("polygon");
          }
        }),
        "\u2002",
        _react2.default.createElement("i", {
          ...
          onClick: function onClick() {
            return _this8.onOperateBtnClick("polyline");
          }
        }),
        "\u2002",
        _react2.default.createElement("i", {
          ...
          onClick: function onClick() {
            return _this8.onOperateBtnClick("group");
          }
        }),
        "\u2002",
        _react2.default.createElement("i", {
